...
- Name: orangehrm-comprehensive-sub-functions.spec.ts >> PIM: Employee List >> WF-2.7: Employee name column sort
- Location: tests/e2e/orangehrm-comprehensive-sub-functions.spec.ts:151:7
...
Locator: locator('th:has-text("Employee Name")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('th:has-text("Employee Name")')
