...
- Name: tricentis.spec.ts >> Tricentis Demo Web Shop - E-Commerce Suite >> 3. User Registration & Authentication >> Registration form accessible
- Location: tests/e2e/tricentis.spec.ts:94:9
...
Locator: locator('input[name*="Email"], input[placeholder*="Email"]')
Expected: visible
Error: strict mode violation: locator('input[name*="Email"], input[placeholder*="Email"]') resolved to 2 elements:
