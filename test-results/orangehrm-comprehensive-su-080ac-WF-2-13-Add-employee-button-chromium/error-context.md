...
- Name: orangehrm-comprehensive-sub-functions.spec.ts >> PIM: Employee List >> WF-2.13: Add employee button
- Location: tests/e2e/orangehrm-comprehensive-sub-functions.spec.ts:181:7
