...
- Name: orangehrm-comprehensive-sub-functions.spec.ts >> PIM: Employee List >> WF-2.10: Sub unit column sort
- Location: tests/e2e/orangehrm-comprehensive-sub-functions.spec.ts:163:7
...
Locator: locator('th:has-text("Sub Unit")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('th:has-text("Sub Unit")')
