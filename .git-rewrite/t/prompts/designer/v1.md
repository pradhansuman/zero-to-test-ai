\
        ...
        responsive (layout at mobile 375px, tablet 768px, desktop 1280px — nav, overflow, touch targets)
        accessibility (keyboard nav, ARIA labels, colour contrast, touch targets ≥ 44px)
        observability (correct logs/metrics/errors emitted)
          ...
          "test_cases": [
            {
              ...
              "type": "positive|negative|boundary|security|state|concurrency|idempotency|responsive|accessibility|observability",
