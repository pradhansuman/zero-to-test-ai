...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> About Us link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:615:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/About Us/i), a[href*="about-us"]". Did you mean to CSS.escape it?
```
