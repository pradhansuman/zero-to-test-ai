...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Header Navigation >> Wishlist link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:586:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Wishlist/i), a[href*="wishlist"]". Did you mean to CSS.escape it?
```
