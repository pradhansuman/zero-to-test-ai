...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> Blog link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:641:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Blog/i), a[href*="blog"]". Did you mean to CSS.escape it?
```
