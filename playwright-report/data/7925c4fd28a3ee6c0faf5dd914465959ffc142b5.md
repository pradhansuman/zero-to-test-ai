...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> Shipping link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:680:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Shipping/i), a[href*="shipping"]". Did you mean to CSS.escape it?
```
