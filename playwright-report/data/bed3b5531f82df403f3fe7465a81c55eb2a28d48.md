...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Account Pages >> My Account link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:696:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/My Account/i), a[href*="customerinfo"]". Did you mean to CSS.escape it?
```
