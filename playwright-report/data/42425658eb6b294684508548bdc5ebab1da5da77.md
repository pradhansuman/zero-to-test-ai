...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Account Pages >> Orders link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:709:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Orders/i), a[href*="customerorders"]". Did you mean to CSS.escape it?
```
