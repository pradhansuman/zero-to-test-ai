...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Header Navigation >> Register link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:547:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Register/i), a[href*="register"]". Did you mean to CSS.escape it?
```
