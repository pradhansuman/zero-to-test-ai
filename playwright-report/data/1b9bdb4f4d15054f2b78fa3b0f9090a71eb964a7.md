...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> Privacy link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:667:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Privacy/i), a[href*="privacy"]". Did you mean to CSS.escape it?
```
