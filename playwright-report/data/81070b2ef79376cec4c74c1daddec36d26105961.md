...
- Name: orangehrm-comprehensive-sub-functions.spec.ts >> ADMIN: User Management >> WF-1.9: Username column sortable
- Location: tests/e2e/orangehrm-comprehensive-sub-functions.spec.ts:84:7
...
Locator: locator('th:has-text("Username")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('th:has-text("Username")')
