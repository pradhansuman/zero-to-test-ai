...
- Name: demowebshop.spec.ts >> Tricentis Demo Web Shop - 70 Approved Tests >> Error Handling & Edge Cases >> Empty cart message displays
- Location: tests/e2e/demowebshop.spec.ts:457:9
...
Call log:
  ...
  - waiting for locator('text=/empty|no items/i').first()
    14 × locator resolved to <div class="count">↵You have no items in your shopping cart.        </div>
