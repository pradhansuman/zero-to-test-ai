...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Header Navigation >> Shopping Cart link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:573:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Shopping Cart/i), a[href*="cart"]". Did you mean to CSS.escape it?
```
