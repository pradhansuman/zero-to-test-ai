...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> Sitemap link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:602:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Sitemap/i), a[href*="sitemap"]". Did you mean to CSS.escape it?
```
