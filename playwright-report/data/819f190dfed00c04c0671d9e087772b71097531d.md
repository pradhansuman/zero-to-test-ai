...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Footer Links >> News link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:654:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/News/i), a[href*="news"]". Did you mean to CSS.escape it?
```
