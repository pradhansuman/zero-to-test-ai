...
- Name: auto-generated.spec.ts >> 🚀 COMPREHENSIVE TEST SUITE - AUTO-GENERATED >> Header Navigation >> Login link navigates correctly
- Location: tests/e2e/auto-generated.spec.ts:560:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "a:has-text(/Login/i), a[href*="login"]". Did you mean to CSS.escape it?
```
